...
const Hero = ({ scrollToPackages }) => {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center text-white relative overflow-hidden from-gray-950 via-slate-900 to-gray-950 px-4 sm:px-6">
      {/* Animated Background */}
      <AnimatedBackground />
